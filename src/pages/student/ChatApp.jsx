...
const ChatApp = () => {
  ...
  const [chatHistory, setChatHistory] = useState([
    ...
    { role: "model", message: "Hey I'm NainBot, how can I assist you today?" }
  ]);
...
const styles = {
  ...
  userMessage: {
    ...
    margin: "10px 0",
    padding: "14px 18px",
    background: "linear-gradient(135deg, #6ecfb1, #6ecfb1)",
    color: "#fff",
  ...
  modelMessage: {
    ...
    margin: "10px 0",
    padding: "14px 18px",
    background: "linear-gradient(135deg, 	#b1c2f3, #2f6e7f)",
    color: "#fff",
